...
snippets = soup.find_all("div", {'class': 'highlight highlight-text-bibtex notranslate position-relative overflow-auto'})
...
all_bibtex_citations = re.findall('(?<=@article)(.*?)(?=\}\s*\})', BibTex_text, flags=re.DOTALL)
...
{'cff-version' : '1.2.0'},
{'message' : ['Pakistan', 'USA', 'India', 'China', 'Germany', 'France', 'Spain']},
{'title' : ''},
{'identifiers' : [{'description':''}, {'type':'doi'}, {'value':''}]},
{'repository-code' : ''},
{'repository' : ''},
